    ...
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-xl rounded-lg">
      ...
      <div className="mt-6 grid grid-cols-2 gap-6 sm:grid-cols-1 lg:grid-cols-2">
        <div className="p-4 bg-blue-100 text-center rounded-md shadow-lg">
          <h2 className="text-2xl font-semibold text-blue-700">{profileState.totalHousesBought}</h2>
          <p className="text-sm text-gray-600">Houses Bought</p>
        </div>
        <div className="p-4 bg-green-100 text-center rounded-md shadow-lg">
          <h2 className="text-2xl font-semibold text-green-700">{profileState.totalPayments?.toFixed(2)}</h2>
