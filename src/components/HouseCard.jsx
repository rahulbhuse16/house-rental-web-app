...
const HouseCard = ({
  ...
  return (
    <React.Fragment>
      <Link
        to={`/house/${id}`}
        className={`sm:max-w-xs flex flex-col rounded group ${!isAvailable ? 'opacity-50 cursor-not-allowed' : ''}`}
      ...
      >
        ...
        <div className="flex flex-col px-2 py-2">
          <div className="flex justify-between items-center">
            ...
            <p className="text-sm font-semibold">{formatIndianRupee(housePrice)}</p>
          </div>
